...
<!--			 style="width: 150px;margin: 30px 0 0 20px;display: inline-block;float: left;">-->

		<div class="header" style="margin-left: 180px">
		...
		<h4 style="font-size: 13pt;text-align: center;background: <?= $main_color; ?>;color: white;padding: 4px;display: block;float:left;width: 100%;margin-top: 40px">
			STUDENT IDENTIFICATION CARD</h4>
		<div class="body">
			<img src="<?= base_url('assets/images/profile/'.$student['photo']); ?>"
					 style="float:left;height: 140px;max-width: 140px;border-radius: 15px;border: 2px solid <?= $main_color; ?>;margin-left: 20px">
		...
		<div class="footer">
		<label
			style="font-size: 13pt;font-weight: bold;text-align: center;background: <?= $main_color; ?>;color: white;padding: 4px;display: block;float:left;width: 100%;margin-top: 6px"><?= $moto; ?></label>
		</div>
	</div>
