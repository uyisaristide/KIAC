	...
	<div style="width: 100%;height:100%;float:left;margin:0;position:relative;<?=$bg;?>;background-size: 100% 100%;background-repeat: no-repeat;">
		...
		<div class="body">
			<img src="<?= base_url('assets/images/profile/'.$student['photo']); ?>"
				 style="float:left;width: 130px;height: 140px;border-radius: 15px;border: 2px solid <?= $main_color; ?>;margin-left: 30px; margin-top: 90px;">

			<div style="float:left;width: 370px;margin-top: 85px;">
				<div style="margin-left: 20px">
					<h4 style="width: auto;margin: 5px auto;font-size: 11pt"><span style="color:  #3a3a3c">Names</span>: <?= $student['name']; ?></h4>
					<h4 style="width: auto;margin: 20px auto;"><span style="color:  #3a3a3c">Course</span>: <?= $student['class']; ?></h4>
					<h4 style="width: auto;margin: 20px auto;"><span style="color:  #3a3a3c">Reg Number</span>: <?= $student['regno']; ?></h4>
					<h4 style="width: auto;margin: 20px auto;"><span style="color:  #3a3a3c">Expiry</span>: <?= date('F Y'); ?></h4>
				</div>
			</div>
		</div>
		<div class="footer">
