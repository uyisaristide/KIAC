...
<section class="section swiper-container swiper-slider swiper-slider-2" id="home" data-loop="true" data-autoplay="50000"
		 data-simulate-touch="false" data-slide-effect="fade" style="<?=empty($type)?'padding-top: 0px':'';?>">
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-11 col-sm-9 col-md-9 col-lg-12 col-xl-12 text-center p-2 mt-3 mb-2 progress-card" style="margin-left:-5px;padding-left:30px;">
				<div class="card">
					<?php
					if (isset($error)) {
						?>
